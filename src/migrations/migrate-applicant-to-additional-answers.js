/**
 * TGC-1206: Previous to v1.208.0 `state.applicant` was stored at the top level of `state` instead of
 * nested under `state.additionalAnswers.applicant`. This migration moves existing documents to
 * the new, v1.208.0+ structure. See https://eaflood.atlassian.net/browse/TGC-1206
 */
